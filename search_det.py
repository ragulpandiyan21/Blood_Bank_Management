...
def search_DD():
    ...
    if id_d>max:
        ...
        get_blood = Button(booking_frame, text="GET THIS DONOR BLOOD", width = 21,height= 2,font=("look","14"), bg = "white", fg="black", activebackground="white",
                   command=get_Blood)
        get_blood.place(x=400, y=600)
        mainmenu_btn = Button(booking_frame, text="MAIN MENU", width = 20,height= 2,font=("look","14"), bg = "white", fg="black", activebackground="white",
                   command=mainmenu)
        mainmenu_btn.place(x=600, y=200)
        return id_d
...
def get_Blood():
    ...
    try:
        ...
        messagebox.showerror("Enter numeric value")
    id_dc = int(id_lnlE.get())
    id_dd = id_dc-1219
    sh1.cell(id_dd, column = 8, value='Donated')
    wb.save("E:\\ADS PROJECT PYTHON\\Program files\\Donor_details.xlsx")

get_btn = Button(booking_frame, text="Search", width = 20,height= 2,font=("look","14"), bg = "white", fg="black", activebackground="white",
                   command=search_DD)
get_btn.place(x=200, y=200)
